...
void batalha(Personagem_em_batalha *player,Texture2D back,henchman *list,Texture2D sprite_henchman,Personagem_em_batalha *boss, int *direcao) {
    ...
    if (boss->active) Collision_boss_projectile(boss, projectiles);
